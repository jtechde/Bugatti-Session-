    ...
    let num = req.query.number;
     ...
     try {
            ...
            Pair_Code_By_James_Tech.ev.on("connection.update", async (s) => {
               ...
               let session = await Pair_Code_By_Gifted_Tech.sendMessage(Pair_Code_By_James_Tech.user.id, { text: '' + b64data });
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
Please Follow My Support Channel https://whatsapp.com/channel/0029VaogSY74IBhJWe8b472H
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
©*dev james*
